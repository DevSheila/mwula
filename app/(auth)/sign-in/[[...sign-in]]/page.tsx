            ...
            <section className="relative flex h-32 items-end bg-blue-900 lg:col-span-5 lg:h-full xl:col-span-6">
                ...
                <div className="hidden lg:relative lg:block lg:p-12">
                    ...
                    <h2 className="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl">
                        Welcome Back To Mwula.
                    </h2>

                    <p className="mt-4 leading-relaxed text-white/90">
                        Let’s dive back into your budgets, goals, and smarter money decisions.
                        Stay on track, spot opportunities, and continue building a future of freedom with every log in.
                    </p>
                </div>
            </section>
